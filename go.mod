module github.com/manovaspace/orbit-auth
...
replace (
	github.com/manovaspace/orbit-notifications => ../orbit-notifications
	github.com/manovaspace/orbit-observability => ../orbit-observability
)
